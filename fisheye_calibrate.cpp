...
int main(int argc, char** argv){
	...
	Mat img_0 = imread("calib_image\\chessboard01.jpg", 0);
	...
	Mat img_1 = imread("calib_image\\chessboard02.jpg", 0);
	resize(img_1, img_1, dsize, 0, 0, INTER_AREA);
	Mat img_2 = imread("calib_image\\chessboard03.jpg", 0);
